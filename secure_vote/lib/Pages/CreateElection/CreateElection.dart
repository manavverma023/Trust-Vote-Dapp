...
class _CreateElectionState extends State<CreateElection> {
  bool loading = true;
  String apiUrl =
      "https://sepolia.infura.io/v3/5c5e2978280541dc933aad92670ac173";
  int electionCount = 0;
                                      ...
                                      children: <Widget>[
                                        ...
                                        Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            const SizedBox(height: 5),
                                            Text(
                                              "Start Date: " + DateFormat.yMMMMd().format(DateTime.fromMillisecondsSinceEpoch(data[3].toInt())),
                                              overflow: TextOverflow.ellipsis,
                                              softWrap: true,
                                              style: const TextStyle(
                                                  fontSize: 15,
                                            ...
                                            const SizedBox(height: 5),
                                            Text(
                                              "End Date: " + DateFormat.yMMMMd().format(DateTime.fromMillisecondsSinceEpoch(data[4].toInt())),
                                              overflow: TextOverflow.ellipsis,
                                              softWrap: true,
                                              style: TextStyle(
                                                  fontSize: 15,
